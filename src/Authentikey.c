...
PBL_APP_INFO(MY_UUID,
		"Authentikey", "pokey9000/zandegran",
		1, 1, /* App version */
...
TextLayer tim;
Layer line_layer, keyImage;
BmpContainer keyImageContainer;
...
void handle_init(AppContextRef ctx) {
    ...
    //Remaining Time
    text_layer_init(&tim, GRect(60, 106, 50/* width */, 50 /* height */));
	...
	layer_add_child(&window.layer, &tim.layer);
    ...
    /*
    //Key
    bmp_init_container(RESOURCE_ID_IMAGE_KEY,&keyImageContainer);
    keyImageContainer.layer.layer.frame.origin.x=5;
    keyImageContainer.layer.layer.frame.origin.y=8;
    layer_add_child(&window.layer, &keyImageContainer.layer.layer);*/
...
void handle_deinit(AppContextRef ctx) {
    ...
    bmp_deinit_container(&keyImageContainer);
}
